namespace DropTest
{
    ...
    {
#if MACCATALYST
        private DropTest.Platforms.MacCatalyst.DragDropHandler handle;
#endif
        public MainPage()
        {
            InitializeComponent();
...
#if MACCATALYST
            DropTest.Platforms.MacCatalyst.DragDropHandler handle = new DropTest.Platforms.MacCatalyst.DragDropHandler(this.blazorWebView.Handler.PlatformView as UIKit.UIView);
            handle.AllowDrop = true;
#endif
        }
